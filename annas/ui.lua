...
function Ui.showSearchDialog(parent_annas, def_input, Ota)
...
function Ui.showBookDetails(parent_annas, book, clear_cache_callback)
    ...
    if book.cover and book.cover ~= "" and book.hash then
        table.insert(details_menu_items, {
            ...
            mandatory = "\u{25B7}",
            callback = function()
                parent_annas:downloadAndShowCover(book)
            end})
    end
